...
export default function HelloWorld(props: HelloWorldProps) {
  ...
  return (
    <section
      ref={helloWorld}
      className="relative z-2 bg-black text-white min-h-[200svh] flex gap-8 px-32"
    >
      <motion.h1
        className="sticky top-1/2 -translate-y-1/2 basis-1/3 font-extrabold text-6xl h-min"
        style={{opacity: opacity.get() === 1 ? opacity : scrollYProgress, scale: progress2}}
      >
        salve, salve!
      </motion.h1>
      <div className="basis-2/3 grid gap-16 justify-center py-32">
        <p className="leading-relaxed max-w-prose text-3xl self-center">
